...
public interface Types {
    Types add(Class<?> klass);

    <T> Types add(Class<T> klass, StringMapping<T> mapping);

    <T> Types add(Class<T> klass, Callable1<StringMappings, StringMapping<T>> mappingCallable);
