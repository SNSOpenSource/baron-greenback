...
import static sky.sns.barongreenback.crawler.failures.FailureRepository.CRAWLER_ID;
import static sky.sns.barongreenback.crawler.failures.FailureRepository.DURATION;
import static sky.sns.barongreenback.crawler.failures.FailureRepository.JOB_TYPE;
import static sky.sns.barongreenback.crawler.failures.FailureRepository.REASON;
import static sky.sns.barongreenback.crawler.failures.FailureRepository.RECORD;
import static sky.sns.barongreenback.crawler.failures.FailureRepository.REQUEST_TIME;
import static sky.sns.barongreenback.crawler.failures.FailureRepository.SOURCE;
