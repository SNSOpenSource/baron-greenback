...
import sky.sns.barongreenback.actions.ActionsModule;
import sky.sns.barongreenback.batch.BatchModule;
import sky.sns.barongreenback.crawler.CrawlerModule;
import sky.sns.barongreenback.crawler.executor.ExecutorModule;
import sky.sns.barongreenback.crawler.failures.FailureModule;
import sky.sns.barongreenback.jobshistory.JobsHistoryModule;
import sky.sns.barongreenback.less.LessCssModule;
import sky.sns.barongreenback.persistence.PersistenceModule;
import sky.sns.barongreenback.search.SearchModule;
import sky.sns.barongreenback.shared.SharedModule;
import sky.sns.barongreenback.views.FacetsModule;
import sky.sns.barongreenback.views.ViewsModule;
