...
import static sky.sns.barongreenback.shared.Forms.NUMBER_OF_FIELDS;
import static sky.sns.barongreenback.shared.Forms.addTemplates;
import static sky.sns.barongreenback.shared.ModelRepository.MODEL_TYPE;
import static sky.sns.barongreenback.views.ViewsRepository.clean;
import static sky.sns.barongreenback.views.ViewsRepository.name;
import static sky.sns.barongreenback.views.ViewsRepository.priority;
import static sky.sns.barongreenback.views.ViewsRepository.valueFor;
