...
public class PaginatedHttpJobTest {
    ...
    public void ifCheckpointFoundReturnNone() throws Exception {
        ...
        PaginatedHttpJob job = PaginatedHttpJob.paginatedHttpJob(context, null, null);
    ...
    public void shouldHandleNoMore() throws Exception {
        ...
        assertThat(PaginatedHttpJob.paginatedHttpJob(context, null, null).additionalWork(null, null), is(none(PaginatedHttpJob.class)));
    }
}
